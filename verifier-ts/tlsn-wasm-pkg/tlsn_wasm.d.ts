...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures_____invoke__h4a7fcf3a9b3f17dc: (a: number, b: number) => void;
  readonly closure3292_externref_shim: (a: number, b: number, c: any, d: any) => void;
