...
export const closure1916_externref_shim: (a: number, b: number, c: any) => void;
export const closure45_externref_shim: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__h4a7fcf3a9b3f17dc: (a: number, b: number) => void;
export const closure3292_externref_shim: (a: number, b: number, c: any, d: any) => void;
